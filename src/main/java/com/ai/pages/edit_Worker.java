...
public class edit_Worker {
	...
	@FindBy(xpath="//div[3]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/button[1]")
	...
	private WebElement click_on_Education_qualificatiion;

	@FindBy(xpath="//body[1]/div[5]/div[1]/ul[1]/li[5]")
	...
	public edit_Worker(WebDriver driver) 
	{ 
		this.driver = driver;
	...
	public void scneario2() throws InterruptedException, AWTException {
		...
		Enter_Name.sendKeys("VENAKTA RAJESH REDDY");
		...
		Enter_aadhar_number.sendKeys("676519328944");
		System.out.println("enter AADHAR number");
		Thread.sleep(3000);

		click_on_Education_qualificatiion.click();
		...
		/*click_on_Education_qualificatiion.sendKeys("bachelor");
		...
		enter_Current_Address.sendKeys("1-134-1,pamuru");
		...
		enter_email_address.sendKeys("rajesh+1@hunar.ai");
		...
		Enter_current_Salary.sendKeys("150000");
		System.out.println("enter current salary");
		Thread.sleep(3000);

		enter_expected_slary.sendKeys("200000");
		...
		Enter_Account_Holders_name.sendKeys("RAJESH REDDY");
